    ...
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-dark
       text-light py-3 px-6 shadow-dark cursor-pointer absolute dark:text-dark
        dark:bg-light lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent
...
const Skills = () => {
  return (
    <>
      ...
      sm:bg-circularLightSm xs:dark:bg-circularDarkSm
      "
      >
        <motion.div
        ...
        <Skill name="Javascript" x="1vw" y="-19vw" />
        <Skill name="ReactJS" x="10vw" y="6vw" />
        <Skill name="Docker" x="-20vw" y="-18vw" />
        <Skill name="Typescript" x="15vw" y="-2vw" />
        <Skill name="NodeJS" x="32vw" y="-5vw" />
        <Skill name="NestJS" x="-12vw" y="-14vw" />
        <Skill name="Python" x="-18vw" y="5vw" />
        <Skill name="Django" x="14vw" y="13vw" />
        <Skill name="PHP" x="25vw" y="-10vw" />
        <Skill name="JAVA" x="15vw" y="-7vw" />
        <Skill name="AWS" x="-3vw" y="16vw" />
        <Skill name="MongoDB" x="-22vw" y="14vw" />
        <Skill name="Postgres / MySQL" x="-12vw" y="-7vw" />
        <Skill name="TypeORM / Knex.js " x="-17vw" y="22vw" />
        <Skill name="Git/Github" x="17vw" y="20vw" />
      </div>
    </>
  );
};
